...
func init() {
	m.Register(func(app core.App) error {
		...
		// remove field
		collection.Fields.RemoveById("_clone_Xezf")

		// remove field
		collection.Fields.RemoveById("_clone_MtML")

		// remove field
		collection.Fields.RemoveById("_clone_BQ8Y")

		// remove field
		collection.Fields.RemoveById("_clone_lq3Z")

		// remove field
		collection.Fields.RemoveById("_clone_TpyV")

		// remove field
		collection.Fields.RemoveById("_clone_DoH1")

		// remove field
		collection.Fields.RemoveById("_clone_gHQR")

		// remove field
		collection.Fields.RemoveById("_clone_rO6U")
