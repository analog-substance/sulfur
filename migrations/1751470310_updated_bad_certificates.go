...
func init() {
	m.Register(func(app core.App) error {
		...
		// remove field
		collection.Fields.RemoveById("_clone_qaCU")

		// remove field
		collection.Fields.RemoveById("_clone_UEWT")

		// remove field
		collection.Fields.RemoveById("_clone_Xt6p")

		// remove field
		collection.Fields.RemoveById("_clone_GcTM")

		// remove field
		collection.Fields.RemoveById("_clone_HxGJ")

		// remove field
		collection.Fields.RemoveById("_clone_vaH2")

		// remove field
		collection.Fields.RemoveById("_clone_69vR")

		// remove field
		collection.Fields.RemoveById("_clone_XVGG")
